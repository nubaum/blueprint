# Bllueprint – Clean Architecture + DDD + Language Platform
...
In Bllueprint, `Page` is used exclusively for large application modes.
...
Bllueprint intentionally relies on the default behavior of WPF UI navigation, where:
