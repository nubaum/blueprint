...
public partial class FloatingTabWindow
{
    ...
    private void FloatingTabWindow_Closed(object? sender, System.EventArgs e)
    {
        ...
        WeakEventManager<UIElement, DragEventArgs>.RemoveHandler(this, nameof(Drop), FloatingTabWindow_Drop);
        WeakEventManager<UIElement, DragEventArgs>.RemoveHandler(this, nameof(DragOver), FloatingTabWindow_DragOver);
        WeakEventManager<UIElement, DragEventArgs>.RemoveHandler(this, nameof(DragLeave), FloatingTabWindow_DragLeave);
        WeakEventManager<Window, EventArgs>.RemoveHandler(this, nameof(Closed), FloatingTabWindow_Closed);
    }
